...
const Dashboard = () => {
  ...
  return (
    <>
	  ...
	  <div className="absolute bottom-10 right-10 bg-primary rounded-full p-1 cursor-pointer hover:scale-110 transition-transform duration-300 shadow-2xl">
	  	<Plus className="text-background" size={40} onClick={() => navigate("/create")}/>
	  </div>
    </>
  );
};
