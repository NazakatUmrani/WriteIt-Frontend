                                        ...
                                        <CardContent>
                                                <div className="grid w-full items-center gap-4">
                                                        ...
                                                        <div className="flex flex-col items-start space-y-1.5">
                                                                ...
                                                                <Input id="password" type="password" placeholder="Enter a strong password." required minLength={8} />
                                                        </div>
                                                        <div className="flex flex-col items-start space-y-1.5">
                                                                <Label htmlFor="cpassword">Confirm Password</Label>
                                                                <Input id="cpassword" type="password" placeholder="Enter your password again." required minLength={8} />
                                                        </div>
                                                </div>
                                        </CardContent>
